...
class CryButtons {
  ...
  static delete(context, onPressed, {showLabel = true}) => CryButton(
      label: showLabel ? S.of(context).delete : null,
      iconData: Icons.delete,
      onPressed: onPressed);

  static edit(context, onPressed, {showLabel = true}) => CryButton(
      label: showLabel ? S.of(context).edit : null,
      iconData: Icons.edit,
      onPressed: onPressed);
  ...
  static save(context, onPressed, {showLabel = true}) => CryButton(
      label: showLabel ? S.of(context).save : null,
      iconData: Icons.save,
      onPressed: onPressed);
  ...
  static commit(context, onPressed, {showLabel = true}) => CryButton(
      label: showLabel ? S.of(context).commit : null,
      iconData: Icons.done,
      onPressed: onPressed);
}
